    ...
    <div className="home-container">
      ...
      <main className="content-container">
        ...
        <Link to="/privacy-policy">
          <img src={privacyPolicy} alt="Privacy Policy" className="icon-hover" />
        </Link>
          ...
          <Link to="/instructions">
            <img src={enterPhotobooth} alt="Enter Photobooth" className="icon-hover" />
          </Link>
          ...
          <div className="photobooth-right">
            ...
            <Link to="/about">
              <img src={about} alt="About" className="about-label icon-hover" />
            </Link>
              <img
                src={homepic1}
                alt="homepic1"
        ...
        <section className="perfume-section">
          <div className="perfume-left-column">
            <div className="perfume-top-row">
              <img src={cattodolist} alt="Cat to-do list" className="perfume-item1" />
              <img
                src={homepic1}
                alt="Homepic 1"
                ref={perfumePic1Ref}
          ...
          <div className="perfume-right-text">
            A wall full of your memories
          </div>
        </section>
